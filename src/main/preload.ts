...
const api: IpcApi = {
  ...
  exportUrssafReport:   (year: number)         => ipcRenderer.invoke('exports:urssafReport', year),
  ...
  licenseVerifyOnline:        ()             => ipcRenderer.invoke('license:verifyOnline'),
  licenseGetDeviceId:         ()             => ipcRenderer.invoke('license:getDeviceId'),
  licenseGetDevices:          ()             => ipcRenderer.invoke('license:getDevices'),
  licenseDeactivateDevice:    (deviceId, reason) => ipcRenderer.invoke('license:deactivateDevice', deviceId, reason),
  licenseGetRestrictionState:     ()             => ipcRenderer.invoke('license:getRestrictionState'),
  licenseGetLastCheck:            ()             => ipcRenderer.invoke('license:getLastCheck'),
  licenseDetectClockRollback:     ()             => ipcRenderer.invoke('license:detectClockRollback'),
  licenseRefresh:                 ()             => ipcRenderer.invoke('license:refresh'),
  licenseDeactivateCurrentDevice: ()             => ipcRenderer.invoke('license:deactivateCurrentDevice'),
  releaseCheck:                   (currentVersion) => ipcRenderer.invoke('release:check', currentVersion),
