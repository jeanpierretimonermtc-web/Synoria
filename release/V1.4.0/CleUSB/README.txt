SYNORIA v1.4.0 — Version Clé USB
==================================
...
CONTENU
-------
  Synoria 1.4.0.exe   — Exécutable portable (aucune installation requise)
...
3. Double-cliquez sur "Synoria 1.4.0.exe"
...
1. Fermez Synoria
2. Remplacez "Synoria 1.4.0.exe" par le nouveau fichier exe
